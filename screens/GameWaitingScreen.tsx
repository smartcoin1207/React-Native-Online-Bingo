...
import { setCurrentGameRoom, setGameRoomIdHost, setGameRoomInitial, setGameType } from "../store/reducers/bingo/gameRoomSlice";
...
const GameWaitingScreen = () => {
    ...
    const { isHostParam, gameRoomIdParam }: GameWaitingRouteParams = route.params as GameWaitingRouteParams;
    ...
    useEffect(() => {
        dispatch(setGameRoomIdHost({ gameRoomId: gameRoomIdParam, isHost: isHostParam }))
    }, []);
    ...
    return (
        <View style={[styles.container]}>
            ...
            >
                ...
                >
                    <View style={styles.modalBody}>
                        <Text style={[styles.modalText, { position: 'absolute', top: -30, justifyContent: 'center', padding: 10, paddingHorizontal: 20, borderWidth: 2, borderColor: customColors.blackGrey, borderRadius: 10, backgroundColor: customColors.modalContainerBackgroundColor }]}>
                            ゲームを選択してください
            </Text>
